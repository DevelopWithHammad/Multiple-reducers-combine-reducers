...
})({"9EVk2":[function(require,module,exports) {
...
module.bundle.HMR_BUNDLE_ID = "3371ca16195ef576";
"use strict";
...
},{}],"8Ae4v":[function(require,module,exports) {
...
const store = (0, _redux.createStore)((0, _cartReducerDefault.default), __REDUX_DEVTOOLS_EXTENSION__?.());
store.dispatch({
    type: (0, _cartReducer.ADD_CART_ITEMS),
    payload: {
        productId: 1,
        quantity: 1
    }
...
store.dispatch({
    type: (0, _cartReducer.REMOVE_CART_ITEMS),
    payload: {
        productId: 5
    }
});
...
store.dispatch({
    type: (0, _cartReducer.ADD_CART_ITEMS_QUANTITY),
    payload: {
        productId: 7
    }
});
...
store.dispatch({
    type: (0, _cartReducer.REMOVE_CART_ITEMS_QUANTITY),
    payload: {
        productId: 7
    }
});
...
store.dispatch({
    type: (0, _wishListReducer.ADD_WISHLIST_ITEM),
    payload: {
        productId: 12
    }
});
...
store.dispatch({
    type: (0, _wishListReducer.REMOVE_WISHLIST_ITEM),
    payload: {
        productId: 12
    }
});
...
},{"redux":"anWnS","./reducers/cartReducer":"laF4M","./reducers/wishListReducer":"1BMVg","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"anWnS":[function(require,module,exports) {
...
},{}],"laF4M":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "ADD_CART_ITEMS", ()=>ADD_CART_ITEMS);
parcelHelpers.export(exports, "REMOVE_CART_ITEMS", ()=>REMOVE_CART_ITEMS);
parcelHelpers.export(exports, "ADD_CART_ITEMS_QUANTITY", ()=>ADD_CART_ITEMS_QUANTITY);
parcelHelpers.export(exports, "REMOVE_CART_ITEMS_QUANTITY", ()=>REMOVE_CART_ITEMS_QUANTITY);
...
function cartReducer(state = [], action) {
    if (action.type === ADD_CART_ITEMS) return {
        ...state,
        cardItems: [
            ...state.cardItems,
            action.payload
    ...
    else if (action.type === REMOVE_CART_ITEMS) return {
        ...state,
        cardItems: [
            ...state.cardItems,
            state.cardItems.filter((cardItem)=>cardItem.productId !== action.payload.productId)
        ]
    };
    else if (action.type === ADD_CART_ITEMS_QUANTITY) return {
        ...state,
        cardItems: state.cardItems.map((cardItem)=>{
            if (cardItem.productId === action.payload.productId) return {
                ...cardItem,
    ...
    else if (action.type === REMOVE_CART_ITEMS_QUANTITY) return {
        ...state,
        cardItems: state.cardItems.map((cardItem)=>{
            if (cardItem.productId === action.payload.productId) return {
                ...cardItem,
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"1BMVg":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "ADD_WISHLIST_ITEM", ()=>ADD_WISHLIST_ITEM);
parcelHelpers.export(exports, "REMOVE_WISHLIST_ITEM", ()=>REMOVE_WISHLIST_ITEM);
...
function wishListReducer(state = [], action) {
    if (action.type === ADD_WISHLIST_ITEM) return {
        ...state,
        wishList: [
            ...state.wishList,
            action.payload
    ...
    else if (action.type === REMOVE_WISHLIST_ITEM) return {
        ...state,
        wishList: [
            ...state.wishList,
            state.wishList.filter((item)=>item.productId !== action.payload.productId)
        ]
    };
    else return state;
}

},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["9EVk2","8Ae4v"], "8Ae4v", "parcelRequire2d1f")

//# sourceMappingURL=index.195ef576.js.map
