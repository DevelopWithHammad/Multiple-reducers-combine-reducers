...
const reducer = (0, _redux.combineReducers)({
    product: (0, _productReducer.productReducer),
    cartItems: (0, _cartReducer.cartReducer),
    wishList: (0, _wishListReducer.wishListReducer)
});
const store = (0, _redux.createStore)(reducer, __REDUX_DEVTOOLS_EXTENSION__?.());
store.dispatch((0, _cartReducer.decreaseCartItemQuantity)(7));
store.dispatch((0, _cartReducer.increaseCartItemQuantity)(1));
store.dispatch((0, _cartReducer.addCartItem)(1, 3));
store.dispatch((0, _cartReducer.removeCartItem)(1));
store.dispatch((0, _cartReducer.addCartItem)(3, 2));
store.dispatch((0, _wishListReducer.addWishListItem)(3));
store.dispatch((0, _wishListReducer.removeWishListItem)(3));
store.dispatch((0, _productReducer.removeProduct)(3));
console.log("store ====>", store.getState());

},{"redux":"anWnS","./reducers/cartReducer":"iE7c8","./reducers/wishListReducer":"dECte","./reducers/productReducer":"eT3Ok"}],"anWnS":[function(require,module,exports) {
...
},{}],"iE7c8":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
parcelHelpers.export(exports, "cartReducer", ()=>cartReducer);
...
function cartReducer(state = [], action) {
    ...
    else if (action.type === REMOVE_CART_ITEMS) return state.filter((cartItem)=>cartItem.productId !== action.payload.productId);
    else if (action.type === ADD_CART_ITEMS_QUANTITY) return state.map((cartItem)=>{
    ...
    else if (action.type === REMOVE_CART_ITEMS_QUANTITY) return state.map((cartItem)=>{
        if (cartItem.productId === action.payload.productId) return {
            ...cartItem,
            quantity: cartItem.quantity - 1
        };
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"dECte":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
parcelHelpers.export(exports, "wishListReducer", ()=>wishListReducer);
...
function wishListReducer(state = [], action) {
    ...
    else if (action.type === REMOVE_WISHLIST_ITEM) return state.filter((item)=>item.productId !== action.payload.productId);
    else return state;
}

},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"eT3Ok":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "removeProduct", ()=>removeProduct);
parcelHelpers.export(exports, "productReducer", ()=>productReducer);
...
function productReducer(state = (0, _productList.productList), action) {
    if (action.type === REMOVE_PRODUCT) return state.filter((product)=>product.id !== action.payload.productId);
    return state;
}

},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","../productList":"dCC0l"}],"dCC0l":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["hPIHA","igcvL"], "igcvL", "parcelRequire2d1f")
